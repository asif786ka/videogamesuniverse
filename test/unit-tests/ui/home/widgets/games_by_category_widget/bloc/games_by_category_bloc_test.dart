...
import 'package:videogames/repository/game_repository.dart';
import 'package:videogames/repository/models/result.dart';
import 'package:videogames/repository/models/result_error.dart';
...
void main() {
  ...
  group('CategoryBloc', () {
    ...
    test(
      ...
      () {
        expect(
          GamesByCategoryBloc(gameRepository: gameRepository).state.status.isInitial,
          isTrue,
        );
      },
    );
